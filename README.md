...
**I believe there is a market opportunity for software to fill this gap. I am talking about time management software that takes a single person centric view and works to be well integrated with existing systems.** Including systems that exist for tracking larger projects, like Azure DevOps but also including systems that are about smaller and more informal asks like email, calendar, and instant message. This software would span between work and personal life and also need the ability to understand and prioritize all kinds of work rather than just projects. It should be designed to keep working during the "fall back" phase and it should look to minimize and reduce the amount of things that one needs to keep in their head as much as possible. I believe the seer size of the self help industry implies the potential market opportunity this presents, but I myself have no interest in commercialization because time management software is not my calling in life. I am getting involved because this can help me achieve my potential and properly leverage my neurodiversity as a strength. I am getting involved because I need this.
