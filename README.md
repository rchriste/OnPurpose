...
Over the past few years I have been on a journey to rethink and re-imagine how a computer can better help with the problem of time and task management. I am neurodiverse and I have a belief that better to do software can greatly improve my mental health. I overthink things, I am **very** out of sight, out of mind, and when things come up I struggle to properly return to things. These mental health issues make it difficult for me to reason out the right thing to do in the moment. I believe that to do software should be able to help me with these problems but everything I have tried has only made me feel overwhelmed when I look at the list and over time the software just does not provide hope.

**A few years ago I had one of those, "I guess I'll just have to do it myself!" moments.** My goal was to figure out a user interface (UI) and a user experience (UX) for a to-do like program that actually addressed these mental health issues. I have incorporated my interpretation of ideas discussed by David Allen and Steven Covey in their seminole books. I have been inspired by the successes (and failures) of my neurodiverse friends. I have paid attention to the implementation challenges of following a routine given by child therapists, adult therapists, professional retirement home staff, and some of the research done by the academic community that researches how to help the neurodiverse. One of my realizations during this journey is that I should define my own opinionated time management system and then work out a UI & UX that implements this system.

This _On Purpose_ project was created as a place for me to implement my ideas and show them to others with a working program. I am using this program now, but as of today what I have written is very partial and does not yet demonstrate the core of my vision. I am targeting the summer of 2024 as an upcoming milestone for when I hope to have a console/text based program that does show my vision. I should also mention that as much as possible my program is an extension of the Microsoft platform; this means a program that runs on Microsoft Windows and integrates with Microsoft Email & Calendar, Azure Devops, Microsoft To Do, and Microsoft Teams.
